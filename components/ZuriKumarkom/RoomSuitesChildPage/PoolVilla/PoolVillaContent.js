    ...
    return (
        <>
            <Container className='p-0 py-4 text-center'>
                ...
                <Col className='px-5'>
                    <p>
                        The Zuri prides itself on being one of the few resorts with private pool villas in Kumarakom, Kerala. Spread out over 70 square metres, the Presidential Villa comprises of a living and dining room, master bedroom, semi-outdoor bathroom and a private garden overlooking an independent pool. Make memories with your loved ones while surrounded by the pristine beauty of <span className='text-black '>Kerala’s backwaters</span> and the absolute privacy that Zuri gives you.
                    </p>
