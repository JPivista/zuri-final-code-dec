        ...
        <Container className='p-md-0 p-2'>
            ...
            <Col className='py-3'>
                ...
                <ul>
                    ...
                    <li>Buffet Breakfast & Dinner per night of stay at Waterfalls Café</li>
                    <li>Evening Tea</li>
                    <li>Complimentary wireless internet (maximum 3 devices per room)</li>
                    <li>Complimentary use of Swimming Pool</li>
                    <li>Benefits at Deltin Zuri Casino – Get an Entry Discount of Rs. 500 and additional Rs. 500 worth chips on purchase of Premium and VIP passes</li>
                    ...
                    <li>35% Discount on availing Buffet Lunch and 15% discount on “a la carte “ orders at the coffee shop</li>
                </ul>
            ...
            <Col className='pb-3'>
                ...
                <ul>
                    ...
                    <li>Additional Child meal supplement at INR 800/- per child per night. Extra Bed at INR 2000/- (tax inclusive) per night</li>
...
export default MonsonInduGoaContent