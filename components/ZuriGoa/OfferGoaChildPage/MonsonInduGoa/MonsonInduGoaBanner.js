...
const MonsonInduGoaBanner = () => {
    const BannerImg = {
        backgroundImage: `url('/goa/offers/monsonn_undulgence_banner.png')`,
        height: 466,
        ...
        <Container className='p-0 w-100'>
            ...
            <Col className='d-flex flex-row flex-wrap p-0 align-items-center' >
                ...
                <Link href="/beach-resorts-in-goa/offers/"
                    className='text-decoration-none mb-0'>
                    <h6 className=' banner-breadcrumbs m-0 text-black'>Offers</h6>
                </Link>
            </Col>
        </Container>
    )
...
export default MonsonInduGoaBanner